...
const SRecord = ({handleSupInvoice}) => {
    ...
    const filterInvoices = async(e) => {
        try {
            const res = await fetch("/search-supplier-invoices-main", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
    ...
    const getInvoices = async(e) => {
        try {
            const res = await fetch("/get-supInvoices", {
                method: "GET",
                headers: {
                    "Content-Type": "application/json"
                },
    ...
    const payAllAmount = async(e) => {
        ...
        if(topay !== "0$"){
        try {
            const res = await fetch("/update-supplier-invoice", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
    ...
    const deleteInvoice = async(e) => {
        ...
        try {
            const res = await fetch("/delete-supplier-invoice", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
    ...
    const navigateInvoice = async(e) => {
        ...
        handleSupInvoice(invNo, email)
    }

    const searchData = async(e) => {
        console.log(search)
        try {
            const res = await fetch("/search-suppliers", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
                                    ...
                                    customer.invoices.map((inv) => (
                                        <tr>
                                            ...
                                            <td className="last" id={customer.email}>
                                                ...
                                                <NavLink to="/suppliers-records-invoice" id={inv.invNo}><i className="fa fa-arrow-right" id={customer.email} onClick={navigateInvoice}></i></NavLink>
                                            </td>
                                        </tr>
                                    ))
                                    }
