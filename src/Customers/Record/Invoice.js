...
const submitUpdate = async(e) => {
    ...
    if(amountRem < updates.pay){
        ...
        try {
            const res = await fetch("/add-customers-invoices", {
                method: "POST",
                headers: {
...
const getInvoice = async(e) => {
    ...
    try {
        const res = await fetch("/get-customer-invoice", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
const getCustomer = async(e) => {
    console.log(invNo, email)
    try {
        const res = await fetch("/get-customer-data", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
